...
# Article Guide — toilet.phenolic.id
...
Source route evidence: sitemap XML, 1100 routes discovered during packet generation
Reader community name: `Phenolic.id`
...
- Address the reader warmly as `Sobat Phenolic.id`, `Kawan Phenolic.id`, or `Teman Phenolic.id`. Use the exact opening salutation assigned inside the article file.
